            ...
            <div class="container">
                <div class="page-inner">
                            ...
                            <div class="row">
                                <div class="col-xl-4">
                                    <div class="card">
                                        ...
                                        // Periksa apakah session id_rw telah diset
                                        if (isset($_SESSION['id_rw'])) {
                                            $id_rw = $_SESSION['id_rw'];

                                            // Query SQL untuk mengambil data rw berdasarkan id_rw dari session
                                            $query = "SELECT * FROM rw WHERE id_rw = '$id_rw'";
                                            $result = mysqli_query($koneksi, $query);

                                            // Periksa apakah query berhasil dieksekusi
                                            if ($result) {
                                                // Periksa apakah terdapat data rw
                                                if (mysqli_num_rows($result) > 0) {
                                                    // Ambil data rw sebagai array asosiatif
                                        ...
                                        <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                            <a href="javascript:void(0)"
                                                ...
                                                <?php if (!empty($rw['fp'])): ?>
                                                <img src="../../assets/img/fp_pengguna/rw/<?php echo $rw['fp']; ?>"
                                            ...
                                            <h4 class="text-center mt-3"><?php echo $rw['nama_rw']; ?></h4>
                                            <h5 class="text-center mb-2"><?php echo $rw['username']; ?></h5>
                                        </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                <div class="tab-pane fade show active profile-overview"
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-9 col-md-8"><?php echo $rw['password']; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_rw" id="id_rw"
                                                            value="<?php echo $rw['id_rw']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                                class="col-md-4 col-lg-3 col-form-label">Nama
                                                                Lengkap</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_rw" type="text" class="form-control"
                                                                    id="nama_rw"
                                                                    value="<?php echo $rw['nama_rw']; ?>" />
                                                            </div>
                                                        </div>
                    ...
                    <?php
                                                    ...
                                                    // Jika tidak ada data rw
                                                    echo "Tidak ada data rw.";
                                                }
                                            } else {
                                                // Jika query tidak berhasil dieksekusi
                                                echo "Gagal mengambil data rw: " . mysqli_error($koneksi);
                                            }
                                        } else {
                                            // Jika session id_rw tidak diset
                                            echo "Session id_rw tidak tersedia.";
                                        }
