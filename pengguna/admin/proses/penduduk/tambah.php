...
$query = "INSERT INTO penduduk (no_kk, nik, nama, tpt_lahir, tgl_lahir, jk, alamat, id_rt, agama, stts_perkawinan, pendidikan, pekerjaan, status) 
          VALUES ('$no_kk', '$nik', '$nama', '$tpt_lahir', '$tgl_lahir', '$jk', '$alamat', '$id_rt', '$agama', '$stts_perkawinan', '$pendidikan', '$pekerjaan', '$status')";
