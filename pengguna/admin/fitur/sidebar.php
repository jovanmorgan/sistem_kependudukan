    ...
    <div class="sidebar-logo">
        ...
        <div class="logo-header" data-background-color="orange">
            <a href="dasboard" class="logo">
                <img src="../../assets/img/kantor_desa/logo.png" alt="navbar brand" class="navbar-brand" height="40px" />
    ...
    <div class="sidebar-wrapper scrollbar scrollbar-inner" data-background-color="orange">
        <div class="sidebar-content">
            <ul class="nav nav-secondary">
                ...
                <li class="nav-item <?php echo ($current_page == 'rt') ? 'active' : ''; ?>">
                    <a href="rt">
                        <i class="<?php echo getIconForPage('rt'); ?>"></i>
                        <p>Rukun Tetangga</p>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'rw') ? 'active' : ''; ?>">
                    <a href="rw">
                        <i class="<?php echo getIconForPage('rw'); ?>"></i>
                        <p>Rukun Warga</p>
                    </a>
                </li>
                <li class="nav-item <?php echo ($current_page == 'lurah') ? 'active' : ''; ?>">
                    <a href="lurah">
                        <i class="<?php echo getIconForPage('lurah'); ?>"></i>
                        <p>Lurah</p>
                    </a>
                </li>
                <li class="nav-section">
