...
<body>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-warning btn-sm"
                                                                            onclick="openEditModal('<?php echo $row['id_rt']; ?>', '<?php echo $row['nik']; ?>', '<?php echo addslashes($row['nama_rt']); ?>', '<?php echo addslashes($row['username']); ?>', '<?php echo addslashes($row['alamat']); ?>', '<?php echo addslashes($row['rt']); ?>')">Edit</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <!-- Nama RT -->
                                <div class="mb-3">
                                    <label for="nama_rt" class="form-label">Nama</label>
                                    <input type="text" id="nama_rt" name="nama_rt" class="form-control" required>
                                </div>

                                <div class="mb-3">
                                    <label for="rt" class="form-label">RT</label>
                                    <input type="number" id="rt" name="rt" class="form-control" required>
                                </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <!-- Nama RT -->
                                <div class="mb-3">
                                    <label for="edit_nama_rt" class="form-label">Nama</label>
                                    <input type="text" id="edit_nama_rt" name="nama_rt" class="form-control" required>
                                </div>

                                <div class="mb-3">
                                    <label for="rt" class="form-label">RT</label>
                                    <input type="number" id="edit_rt" name="rt" class="form-control" required>
                                </div>
    ...
    <script>
        function openEditModal(id, nik, nama_rt, username, alamat, rt) {
