...
<body>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <button class="btn btn-warning btn-sm m-1"
                                                                            onclick="openEditModal('<?php echo $row['id_rw']; ?>', '<?php echo $row['nik']; ?>', '<?php echo addslashes($row['nama_rw']); ?>', '<?php echo addslashes($row['username']); ?>', '<?php echo addslashes($row['alamat']); ?>', '<?php echo addslashes($row['rw']); ?>')">Edit</button>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <!-- Nama rw -->
                                <div class="mb-3">
                                    <label for="nama_rw" class="form-label">Nama</label>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <div class="mb-3">
                                    <label for="rw" class="form-label">RW</label>
                                    <input type="text" id="edit_rw" name="rw" class="form-control" required>
                                </div>
    ...
    <script>
        function openEditModal(id, nik, nama_rw, username, alamat, rt) {
            ...
            document.getElementById('edit_rw').value = rt;
            editModal.show();
        }
    </script>
