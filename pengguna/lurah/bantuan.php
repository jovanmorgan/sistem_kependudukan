...
<body>
                        ...
                        <div class="modal-body">
                            <form id="tambahForm" method="POST" action="proses/<?= $page_title_proses ?>/tambah.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="nama_bantuan" name="nama_bantuan" class="form-control"
                                        required>
                                </div>
                        ...
                        <div class="modal-body">
                            <form id="editForm" method="POST" action="proses/<?= $page_title_proses ?>/edit.php"
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="edit_nama_bantuan" name="nama_bantuan" class="form-control"
                                        required>
                                </div>
    ...
    <script>
        function openEditModal(id_bantuan, no_kk, nama_bantuan) {
            let editModal = new bootstrap.Modal(document.getElementById('editModal'));
            document.getElementById('edit_id').value = id_bantuan;
            document.getElementById('edit_no_kk').value = no_kk;
            document.getElementById('edit_nama_bantuan').value = nama_bantuan;
            editModal.show();
        }
    </script>
