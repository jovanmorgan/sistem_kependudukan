                                                    ...
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <?php if (!empty($lurah['fp'])): ?>
                                                                <img src="../../assets/img/fp_pengguna/lurah/<?php echo $lurah['fp']; ?>"
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $lurah['nama_lurah']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $lurah['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                <div class="tab-pane fade show active profile-overview"
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-9 col-md-8">
                                                            <?php echo $lurah['username']; ?>
                                                        </div>
                                                    </div>

                                                    <div class="row mt-3">
                                                        <div class="col-lg-3 col-md-4 label">Passweord</div>
                                                        <div class="col-lg-9 col-md-8"><?php echo $lurah['password']; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_lurah" id="id_lurah"
                                                            value="<?php echo $lurah['id_lurah']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                                class="col-md-4 col-lg-3 col-form-label">Nama
                                                                Lengkap</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_lurah" type="text"
                                                                    class="form-control" id="nama_lurah"
                                                                    value="<?php echo $lurah['nama_lurah']; ?>" />
                                                            </div>
                                                        </div>
        ...
        <script>
            ...
            $(document).ready(function() {
                $('#editFotoProfileModal').on('shown.bs.modal', function() {
                    ...
                    var containelurahidth = $('.gambar').width();
                    var containerHeight = $('.gambar').height();
                    cropper = new Cropper($('#editFotoProfilePreview')[0], {
                        aspectRatio: 1, // 1:1 aspect ratio
                        viewMode: 1, // Crop mode
                        minContainelurahidth: containelurahidth, // Set minimum container width to match image container width
