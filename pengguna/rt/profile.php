                                        ...
                                        ?>
                                                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                        <a href="javascript:void(0)"
                                                            ...
                                                            <?php if (!empty($rt['fp'])): ?>
                                                                <img src="../../assets/img/fp_pengguna/rt/<?php echo $rt['fp']; ?>"
                                                        ...
                                                        <h4 class="text-center mt-3"><?php echo $rt['nama_rt']; ?></h4>
                                                        <h5 class="text-center mb-2"><?php echo $rt['username']; ?></h5>
                                                    </div>
                                    </div>
                                </div>
                                <style>
                                            ...
                                            <div class="tab-content pt-2">
                                                <div class="tab-pane fade show active profile-overview"
                                                    ...
                                                    <div class="row mt-3">
                                                        ...
                                                        <div class="col-lg-9 col-md-8">
                                                            <?php echo $rt['username']; ?>
                                                        </div>
                                                    </div>

                                                    <div class="row mt-3">
                                                        <div class="col-lg-3 col-md-4 label">Passweord</div>
                                                        <div class="col-lg-9 col-md-8"><?php echo $rt['password']; ?>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                                                    ...
                                                    <form id="editProfileForm">
                                                        <input type="text" name="id_rt" id="id_rt"
                                                            value="<?php echo $rt['id_rt']; ?>" hidden>
                                                        <div class="row mb-3">
                                                            <label for="fullName"
                                                                class="col-md-4 col-lg-3 col-form-label">Nama
                                                                Lengkap</label>
                                                            <div class="col-md-8 col-lg-9">
                                                                <input name="nama_rt" type="text" class="form-control"
                                                                    id="nama_rt"
